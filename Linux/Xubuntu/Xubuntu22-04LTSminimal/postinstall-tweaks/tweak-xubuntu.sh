...
xargs sudo apt -y purge<purge-packages;sudo apt -y autoremove
...
reboot
# wget https://github.com/clickot/ungoogled-chromium-binaries/releases/download/101.0.4951.64-1/ungoogled-chromium_101.0.4951.64-1.1.AppImage